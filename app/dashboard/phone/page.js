...
export default function Page(){
    ...
    <VStack as={motion.div} initial={{scale: 0.9, opacity: 0}} animate={{scale: 1, opacity: 1}} exit={{scale: 1, opacity: 0}} overflow={'hidden'} width={'full'} background={'white'} rounded={'20px'}>
